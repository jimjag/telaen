    ...
    <td><table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td background="themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.adr_new_entry}</b></td>
