   					...
   					<tr>
   						<td>
   							<div class="yToolbar" id="ParaToolbar">
								   ...
								   <a href="javascript:void(0)" onClick="document.composeForm.switchMode.click()"><font color="#000000" face="Arial" size=2>{$umLabel.view_source}</font></a> | 
								   <a href="javascript:textmode()"><font color="#000000" face="Arial" size=2>{$umLabel.text_mode}</font></a> |
								   <a href="javascript:void(0)" onClick="formatC('formatBlock','removeFormat')"><font color="#000000" face="Arial" size=2>{$umLabel.clear_format}</font></a>
   								</div>
   							</div>
   							<table>
   								<tr>
