  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="themes/aleborgXP/images/menu_back.gif">
        <tr> 
          ...
          <td width="32"><img src="themes/aleborgXP/images/search_off.gif" alt="{$umLabel.search_mnu}" name="search" width="32" height="38" border="0" id="search"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr background="themes/aleborgXP/images/back_list.gif">
    <td height="20" background="themes/aleborgXP/images/back_list.gif"><table width="720" border="0" cellspacing="0" cellpadding="0">
        <tr>
