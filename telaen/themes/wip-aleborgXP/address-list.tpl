...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="themes/aleborgXP/images/menu_back.gif">
        <tr> 
          ...
          <td width="32"><img src="themes/aleborgXP/images/previous_off.gif" alt="{$umLabel.previous_text}" name="previous" width="32" height="38" border="0" id="previous"></td>
  ...
  <tr background="themes/aleborgXP/images/menu_back.gif">
    <form>
      <td height="20" background="themes/aleborgXP/images/menu_back.gif">
<input type="button" value="{$umLabel.adr_new_entry}" onClick="location = '{$umNew}'" style="height: 20px; font-family: verdana;font-size: 9px;">
      </td>
    </form>
  </tr>
</table>
<table width="100%" height="20" border="0" cellpadding="0" cellspacing="0" background="themes/aleborgXP/images/back_list.gif">
  <tr>
    <td> 
      <table width="720" border="0" cellspacing="1" cellpadding="2">
        <tr>

          <td width="270"><strong> &nbsp;{$umLabel.adr_name_hea}</strong></td>

          <td><strong>{$umLabel.adr_email_hea}</strong></td>

          <td width="100" class="headers" align="center"><strong>{$umLabel.adr_edit_hea}</strong></td>
<!---
			 <td width="10%" class="headers"><strong>{$umLabel.adr_expo_hea}</strong></td>
--->

          <td width="100" class="headers" align="center"><strong>{$umLabel.adr_dele_hea}</strong></td>
		</tr>
	</table>
</td>
  </tr>
...
<table width="720" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td width="270" class="default"> &nbsp;<a class="menu" href="{$umAddressList[i].viewlink}">{$umAddressList[i].name}</a>&nbsp;</td>

    <td class="default"><a class="menu" href="{$umAddressList[i].composelink}">{$umAddressList[i].email}</a>&nbsp;</td>

    <td width="100" align="center" class="default"> &nbsp;<a class="menu" href="{$umAddressList[i].editlink}"><img src="themes/aleborgXP/images/edit.gif" width="16" height="16" border="0" alt="{$umLabel.adr_edit_hea}"></a></td>
<!---
                                        <td class="default"> &nbsp;<a class="menu" href="{$umAddressList[i].exportlink}">OK</a></td>
--->

    <td width="100" align="center" class="default"> &nbsp;<a class="menu" href="{$umAddressList[i].dellink}"><img src="themes/aleborgXP/images/delete.gif" width="16" height="16" border="0" alt="{$umLabel.adr_dele_hea}"></a></td>
                                </tr>
                                {/section}
                        </table>
</body>
