...
<head>
<title>UebiMiau - {$umLabel.folders_to} {$umUserEmail}</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="themes/aleborgXP/images/menu_back.gif">
        <tr> 
          ...
          <td width="11"><img src="themes/aleborgXP/images/seperator.gif" width="11" height="38"></td>
          <td width="32"><img src="themes/aleborgXP/images/folders_off.gif" alt="{$umLabel.folders_mnu}" name="folders" width="32" height="38" border="0" id="folders"></td>
  ...
  <tr>
    <td height="20" background="themes/aleborgXP/images/menu_back.gif">&nbsp;<b>{$umLabel.fld_total}</b> 
      {$umTotalUsed}Kb</td>
  </tr>
  ...
  <tr>
    <td height="20" background="themes/aleborgXP/images/menu_back.gif">&nbsp;{$umLabel.quota_usage_info}: 
...
<form name="form1" action="folders.php" method="POST" onsubmit="return create();">
  <tr>
      <td height="20" background="themes/aleborgXP/images/menu_back.gif">&nbsp;
<input type="hidden" name="tid" value="{$umTid}"><input type="hidden" name="sid" value="{$umSid}">
				<input type="hidden" name="lid" value="{$umLid}"><input type="Text" name="newfolder" value="" class="textbox"> &nbsp;<input type="button" value="{$umLabel.fld_make_new}" onClick="create()" style="height: 20px; font-family: verdana;font-size: 9px;">
      </td>
  </tr>
</form>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="20" background="themes/aleborgXP/images/back_list.gif">			

      <table cellspacing="0" cellpadding="0" width="650" border="0">
        <tr align="center"> 
          <td width="200" class="headers" align="left"> 
            <div align="left"><b>{$umLabel.fld_name_hea}</b></div>
          </td>
          <td width="100" class="headers" align="center"> 
            <div align="center"><b>{$umLabel.fld_messages_hea}</b></div>
          </td>
          <td width="100" class="headers" align="center"> 
            <div align="center"><b>{$umLabel.fld_size_hea}</b></div>
          </td>
          <td width="100" class="headers" align="center"> 
            <div align="center"><b>{$umLabel.fld_empty_hea}</b></div>
          </td>
          <td width="100" class="headers" align="center"> 
            <div align="center"><b>{$umLabel.fld_delete_hea}</b></div>
          </td>
        </tr>
      </table>
</td>
...
<table cellspacing="0" cellpadding="0" width="650" border="0" bgcolor="White">
  ...
  <tr> 
    <td width="200" class="default" align="left"> 
      <div align="left">&nbsp;<a href="{$umFolderList[i].chlink}"><img src="themes/aleborgXP/images/index.gif" border="0" align="absmiddle">&nbsp;{$umFolderList[i].name|escape:"html"}</a></div>
    </td>
    <td width="100" class="defaultC" align="center"> 
      <div align="center">{$umFolderList[i].msgs}</div>
    </td>
    <td width="100" class="right" align="center"> 
      <div align="center">{$umFolderList[i].boxsize}Kb</div>
    </td>
    <td width="100" class="defaultC" align="center"> 
      <div align="center"><a href="{$umFolderList[i].emptylink}"><img src="themes/aleborgXP/images/delete.gif" border="0"></a></div>
    </td>
    <td width="100" class="defaultC" align="center"> 
      <div align="center">{$umFolderList[i].del}</div>
    </td>
  </tr>
  {/section} 
</table>
