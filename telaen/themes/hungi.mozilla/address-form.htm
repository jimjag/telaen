    ...
    <td bgcolor="#DDE3EB"><form name="form1" method="post" action="addressbook.php">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td><input size="40" type="text" name="work" value="{$umAddrPhone|escape:"html"}" class="textbox" /></td>
          </tr>
          <tr>
            <td class="headerright">{$umLabel.adr_cell} &nbsp;</td>
            <td><input size="40" type="text" name="work" value="{$umAddrCell|escape:"html"}" class="textbox" /></td>
          </tr>
          <tr>
            <td class="headerright">{$umLabel.adr_note} &nbsp;</td>
            <td><textarea cols="40" rows="5" type="text" name="work" value="{$umAddrNote|escape:"html"}" class="textbox">{$umAddrNote|escape:"html"</textarea></td>
          </tr>
          <tr>
                  ...
                  <tr>
                    <td><table class="buttonTable" cellspacing="0" >
                        <tr>
                          ...
                          <td valign="middle" class="buttonMiddle"><input class="button" type="submit" name="submit" onclick="javascript:document.form1.submit()" value="{$umLabel.adr_save}" /></td>
