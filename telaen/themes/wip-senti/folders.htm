...
<table width="760" height="400" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr valign="bottom">
		...
		<td>
			<a class="menu" href="javascript:folderlist()"><img src="themes/senti/images/folders_selected.gif" width="72" height="61" border="0" alt=""></a></td>
		<td>
	...
	<tr>
	<td width="18"><img src="themes/senti/images/leftside.gif" width="18" height="100%"></td>	<td colspan="13" valign="top" bgcolor="#dddcdc"><br />
					...
					{section name=i loop=$umFolderList}
						<tr>
							<td class="default"><a href="{$umFolderList[i].chlink}"><img src="themes/senti/images/folder.gif"  alt="" border="0">&nbsp;&nbsp;&nbsp;{$umFolderList[i].name|escape:"html"}</a></td>
					...
					<tr>
						<td colspan="5" align="left"><a class="menu" href="javascript:emptytrash()">
							<img src="themes/senti/images/trash.gif" alt="" border="0">&nbsp;&nbsp;{$umLabel.empty_trash_mnu}</a>
						</td>
					</tr>
