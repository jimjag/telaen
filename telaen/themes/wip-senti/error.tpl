...
<html>
<head>
	<title>sentiMail - {$umLabel.err_title}</title>
	...
	<form action="process.php" method="post">		
				<table border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>		
							<td colspan="3" class="mainLoginTable">
								<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
									<tr><td align=right class="title">.: <font color=red size=3><b>{$umLabel.err_title}</b></font> :.</td>
										<tr><td align=right class="cent"><br>
										{$umLabel.err_msg}<br><br>
										...
										<a href="logout.php?sid={$umSid}&tid={$umTid}&lid={$umLid}">{$umLabel.err_exit}</a><br><br>
										</td>
									</table>
															</td>
						</tr>
						...
						<tr>
							<td colspan="3" class="footer" align="center"><a href="http://validator.w3.org/check?uri=referer"><img src="themes/senti/images/w3c2.gif" alt="" border="0"></a></td>
						</tr>
				</table>	
			</form>	
	</body>
