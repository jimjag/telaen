...
<head>
	...
	<script language="JavaScript" src="themes/senti/webmail.js" type="text/javascript"></script>
...
<table width="760" height="400" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr valign="bottom">
		...
		<td>
			<a class="menu" href="javascript:newmsg()"><img src="themes/senti/images/write_selected.gif" width="85" height="61" border="0" alt=""></a></td>
		<td>
	...
	<tr><TD width="18"><img src="themes/senti/images/leftside.gif" width="18" height="100%"></TD>
		<td colspan="13" bgcolor="#dddcdc"><br /><br />
			<table width="100%" border=0 cellspacing=0 cellpadding=5 >
				<tr bgcolor=white>
					<td width="26%" height="18" class="headerright">{$umLabel.to_hea} &nbsp;<a href="javascript:addrpopup()"><img src="themes/senti/images/bookmark_it.gif" width="15" height="12" border="0" alt="<!--%address_tip%-->"></a> &nbsp;</td>
					<td class="default">&nbsp;{$umTo}</td>
				</tr>	
				<tr bgcolor=white>
					<td height="18" class="headerright">{$umLabel.cc_hea} &nbsp;<a href="javascript:addrpopup()"><img src="themes/senti/images/bookmark_it.gif" width="15" height="12" border="0" alt="<!--%address_tip%-->"></a> &nbsp;</td>
					<td class="default">&nbsp;{$umCc}</td>
				</tr>	
				<tr bgcolor=white>
					<td height="18" class="headerright">{$umLabel.bcc_hea} &nbsp;<a href="javascript:addrpopup()"><img src="themes/senti/images/bookmark_it.gif" width="15" height="12" border="0" alt="<!--%address_tip%-->"></a> &nbsp;</td>
				...
				<tr>
					...
					<TD>	<table height="100%" width="100%" border=0 cellspacing=0 cellpadding=0>
						...
						<table width="100%" border=0 cellspacing=1 cellpadding=0>
							<tr>
								<td width="100%" class="default">&nbsp;<a href="javascript:upwin()" class="navigation"><img src="themes/senti/images/attach.gif"  alt="" border="0">&nbsp;&nbsp;{$umLabel.attch_add_new}</a></td>
							</tr>
						</table>
					</TD>
				</tr>	
	...
	<TD width="17"><img src="themes/senti/images/rightside.gif" width="17" height="100%"></TD>	</form>
	</tr>
	<tr>
