...
<head>
	...
	<form action="process.php" method="post">		
				<table border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td class="topEdge" align="left"><img src="themes/senti/images/rounded-top-left.gif" alt=""></td>
							<td class="topEdge" width="450"><img src="themes/senti/images/top-middle.gif" alt="" height="30" width="100%" border="0"></td>
							<td class="topEdge" align="right"><img src="themes/senti/images/rounded-senti-top.gif" alt=""></td>
						</tr>
						<tr>		
							<td colspan="3" class="mainLoginTable">
								<table border="0" width="450" cellspacing="5" cellpadding="5" align="center">
												...
												<tr>
													<td><img src="themes/senti/images/user.gif" alt="username"></td>
													<td><input type=text size=20 name="f_email" value="{$umEmail}"></td>
												</tr>
												{else}
												<tr>
														<td valign="top"><img src="themes/senti/images/user.gif" alt="username"></td>
														<td><input type=text name="f_user" value="{$umUser}"></td>
														<td>{if $umAvailableServers neq 0} <font color="#DDDCDC">{$umServer}</font>{/if}</td>
												</tr>
												{/if}
												<tr>
													<td><img src="themes/senti/images/pass.gif" alt="password"></td>
													<td><input type=password name="f_pass" value=""></td>
													<td><input type="image" src="themes/senti/images/login.gif" value="Submit" alt="Submit"></td>
												</tr>
						...
						<tr>
							...
							<td class="bottomEdge" width="450"><img src="themes/senti/images/bottom-middle.gif" alt="" height="49" width="450" border="0"></td>
