	...
	<tr>
		<td valign="middle">
			<table cellspacing="0" cellpadding="0" width="100%" border="0" class="normal" >
				...
				<td align="center" valign="middle" bgcolor="#EAEAEA" height="70" width="83"><img src="themes/beauvoir/search.gif" border="0" width="31" height="31"><br><font class="inactive">{$umLabel.search_mnu}</font></td>
