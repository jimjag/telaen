...
extract(Telaen::pullFromArray($_GET, array('edate'), 'str'));
extract(Telaen::pullFromArray($_POST, array('eventn', 'edate', 'evsave', 'evdelete', 'starthour', 'stophour', 'startmin', 'stopmin'), 'str'));
...
if ($year > 2009 && $year < 2050 && $month > 0 && $month <  13 && $day > 0 && $day < 32) {
     ...
     */
    $events = new MyMonth($TLN->userfolder, $year, $month);
