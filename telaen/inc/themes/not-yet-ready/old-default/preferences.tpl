  ...
  <tr>
    ...
    <td valign="top"><form id="prefs_form" name="prefs_form" action="preferences.php" method="post">
        ...
        <table cellspacing="1" cellpadding="1" width="100%" border="0" bgcolor="white">
          {if $message}
          <tr>
            <td colspan="2" class="default"><b> {if $message eq "1"}{$smLabel.prf_msg_saved}
              {elseif $message eq "4"}{$smLabel.filter_msg_added}
              {elseif $message eq "5"}{$smLabel.filter_msg_deleted}{/if} </b></td>
          </tr>
          {/if}
          <tr>
