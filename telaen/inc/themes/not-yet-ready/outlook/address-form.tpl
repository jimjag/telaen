  ...
  <tr>
    <td><table width='100%' cellpadding='0' cellspacing='0'>
        <tr>
          ...
          <td width='100%' class="window_title">&nbsp;{if $smAddrID=='N'}{$smLabel.adr_new_entry}{else}{$smLabel.adr_title}{/if}</td>
          <td class='window_title_X'><a href='{$smGoBack}'><img border='0' src='inc/themes/outlook/images/X.png'></a></td>
        </tr>
      </table>
