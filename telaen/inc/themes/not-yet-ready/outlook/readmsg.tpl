          ...
          <td class='toolbar_outer' ><table width='100%' cellpadding='0' cellspacing='0'>
              <tr>
                <td class='toolbar_inner'><table width='0' cellpadding='0' cellspacing='0'>
                    ...
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" onclick="reply()"><acronym title="{$umLabel.reply_mnu}"><img src="inc/themes/outlook/images/icon_reply.gif"><font class='xx-normal'><br>
                      {#reply_mnu#|truncate:13:"...":true}</font></td>
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" onclick="replyall()"><acronym title="{$umLabel.reply_all_mnu}"><img src="inc/themes/outlook/images/icon_replyall.gif"><font class='xx-normal'><br>
                      {#reply_all_mnu#|truncate:13:"...":true}</font></td>
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" onclick="forward()"><acronym title="{$umLabel.forward_mnu}"><img src="inc/themes/outlook/images/icon_forward.gif"><font class='xx-normal'><br>
                      {#forward_mnu#|truncate:13:"...":true}</font></td>
                    <td class="toolbar_splitter"><img src='inc/themes/outlook/images/bar_splitter.gif'></td>
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" onclick="printit()"><acronym title="{$umLabel.print_mnu}"><img src="inc/themes/outlook/images/icon_print.gif"><font class='xx-normal'><br>
                      {#print_mnu#|truncate:13:"...":true}</font></td>
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" onclick="javascript:deletemsg()"><acronym title="{$umLabel.delete_mnu}"><img src="inc/themes/outlook/images/icon_delete.gif"><font class='xx-normal'><br>
                      {#delete_mnu#|truncate:13:"...":true}</font></td>
                    <td class="toolbar_splitter"><img src='inc/themes/outlook/images/bar_splitter.gif'></td>
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" {if $umHavePrevious eq 1}onclick="javascript:window.location='{$umPreviousLink}'"{/if}><acronym title="{$umLabel.previous_mnu}"><img src="inc/themes/outlook/images/icon_previous.gif"><font class='xx-normal'><br>
                      {#previous_mnu#|truncate:13:"...":true}</font></td>
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" {if $umHaveNext eq 1}onclick="javascript:window.location='{$umNextLink}'"{/if}><acronym title="{$umLabel.next_mnu}"><img src="inc/themes/outlook/images/icon_next.gif"><font class='xx-normal'><br>
                      {#next_mnu#|truncate:13:"...":true}</font></td>
                    <td class="toolbar_splitter"><img src='inc/themes/outlook/images/bar_splitter.gif'></td>
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" onclick="addresses()"><acronym title="{$umLabel.address_mnu}"><img src="inc/themes/outlook/images/icon_addressbook.gif"><font class='xx-normal'><br>
                      {#address_mnu#|truncate:13:"...":true}</font></td>
                    <td class="toolbar_button_off" onmouseover="this.className='toolbar_button_on'" onmouseout="this.className='toolbar_button_off'" onmousedown="this.className='toolbar_button_down'" onmouseup="this.className='toolbar_button_on'" onclick="window.location='{$downloadLink}';"><acronym title="{$umLabel.download_mnu}"><img src="inc/themes/outlook/images/icon_download.gif" alt=""><font class='xx-normal'><br>
    ...
    <td><iframe name="process" id="process" style="display:none;"></iframe>
      <table width="100%" border="0" cellspacing="4" cellpadding="0">
        <tr>
          ...
          <td width='*'><font class='xx-normal'>{section name=i loop=$umFromList}<a href="{$umFromList[i].link}" title="{$umFromList[i].title|escape:"html"}">{$umFromList[i].name|default:#no_sender_text#|escape:"html"}</a>&nbsp;<a target="process" href="addressbook.php?name={$umFromList[i].name}&email={$umFromList[i].mail}&page_ref=readmsg&opt=add&id=N&dummy={$umFromList[i].link}" title=""><img src="inc/themes/outlook/images/icon_addtoaddressbook.gif" border=0></a>&nbsp;{/section}</font></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width='*'><font class='xx-normal'>{section name=i loop=$umCCList}{if $firstcc eq "no"};{/if}<a href="{$umCCList[i].link}" title="{$umCCList[i].title|escape:"html"}">{$umCCList[i].name|escape:"html"}</a>&nbsp;<a target="process" href="addressbook.php?name={$umCCList[i].name}&email={$umCCList[i].mail}&page_ref=readmsg&opt=add&id=N&dummy={$umCCList[i].link}" title=""><img src="inc/themes/outlook/images/icon_addtoaddressbook.gif" border=0></a>&nbsp;{assign var="firstcc" value="no"}{/section}</font></td>
        </tr>
        {/if}
        <tr>
