...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="inc/themes/aleborgXP/images/menu_back.gif">
        <tr> 
          ...
          <td width="11"><img src="inc/themes/aleborgXP/images/seperator.gif" width="11" height="38"></td>
          <td width="32"><img src="inc/themes/aleborgXP/images/folders_off.gif" alt="{$umLabel.folders_mnu}" name="folders" width="32" height="38" border="0" id="folders"></td>
  ...
  <tr>
    <td height="20" background="inc/themes/aleborgXP/images/menu_back.gif">&nbsp;<b>{$umLabel.fld_total}</b> 
      {$umTotalUsed}Kb</td>
  </tr>
  ...
  <tr>
    <td height="20" background="inc/themes/aleborgXP/images/menu_back.gif">&nbsp;{$umLabel.quota_usage_info}: 
...
<table cellspacing="0" cellpadding="0" width="650" border="0" bgcolor="White">
  ...
  <tr> 
    <td width="200" class="default" align="left"> 
      <div align="left">&nbsp;<a href="{$umFolderList[i].chlink}"><img src="inc/themes/aleborgXP/images/index.gif" border="0" align="absmiddle">&nbsp;{$umFolderList[i].name|escape:"html"}</a></div>
    </td>
    ...
    <td width="100" class="defaultC" align="center"> 
      <div align="center"><a href="{$umFolderList[i].emptylink}"><img src="inc/themes/aleborgXP/images/delete.gif" border="0"></a></div>
    </td>
    <td width="100" class="defaultC" align="center"> 
