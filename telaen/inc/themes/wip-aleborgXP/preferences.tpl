  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="inc/themes/aleborgXP/images/menu_back.gif">
        <tr> 
          ...
          <td width="32"><img src="inc/themes/aleborgXP/images/options_off.gif" alt="{$umLabel.prefs_mnu}" name="options" width="32" height="38" border="0" id="options"></td>
    ...
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td background="inc/themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_general_title}</b>&nbsp;</td>
  ...
  <tr> 
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                  <td background="inc/themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_trash_title}</b></td>
                <td width="31"><img src="inc/themes/aleborgXP/images/login/right_up_corner.gif" width="31" height="29"></td>
              </tr>
            </table></td>
        </tr>
  ...
  <tr> 
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                  <td background="inc/themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_sent_title}</b></td>
                <td width="31"><img src="inc/themes/aleborgXP/images/login/right_up_corner.gif" width="31" height="29"></td>
              </tr>
            </table></td>
        </tr>
  ...
  <tr> 
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                  <td background="inc/themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_messages_title}</b></td>
                <td width="31"><img src="inc/themes/aleborgXP/images/login/right_up_corner.gif" width="31" height="29"></td>
              </tr>
            </table></td>
        </tr>
  ...
  <tr> 
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                  <td background="inc/themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_signature_title}</b></td>
                <td width="31"><img src="inc/themes/aleborgXP/images/login/right_up_corner.gif" width="31" height="29"></td>
              </tr>
            </table></td>
        </tr>
