...
<head>
	<title>UebiMiau - {$umLabel.prf_title}</title>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="themes/aleborgXP/images/menu_back.gif">
        <tr> 
          ...
          <td width="32"><img src="themes/aleborgXP/images/refresh_off.gif" alt="{$umLabel.refresh_mnu}" name="refresh" width="32" height="38" border="0" id="refresh"></td>
          <td width="11"><img src="themes/aleborgXP/images/seperator.gif" width="11" height="38"></td>
          ...
          <td width="32"><img src="themes/aleborgXP/images/options_off.gif" alt="{$umLabel.prefs_mnu}" name="options" width="32" height="38" border="0" id="options"></td>
    ...
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td background="themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_general_title}</b>&nbsp;</td>
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><table width="650" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                              <td width="233">&nbsp;{$umLabel.prf_name}:</td>
  ...
  <tr> 
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                  <td background="themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_trash_title}</b></td>
                <td width="31"><img src="themes/aleborgXP/images/login/right_up_corner.gif" width="31" height="29"></td>
              </tr>
            </table></td>
        </tr>
                ...
                <td><table width="650" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td><input type="checkbox" name="f_save_trash" onClick="dis()" value="1"{$umSaveTrash}> 
                          <acronym style="cursor: hand;" onClick="f_save_trash.click()">{$umLabel.prf_save_to_trash} 
                          "<b>{$umLabel.trash_extended}</b>"</acronym></td>
                      </tr>
                      <tr> 
                        <td><input type="checkbox" name="f_st_only_read" onClick="return checkDis()" value="1"{$umSaveTrashOnlyRead}> 
                          <acronym style="cursor: hand;" onClick="f_st_only_read.click()">{$umLabel.prf_save_only_read} 
                          "<b>{$umLabel.trash_extended}</b>"</acronym></td>
                      </tr>
                      <tr> 
                        <td><input type="checkbox" name="f_empty_on_exit" value="1"{$umEmptyTrashOnExit}> 
                          <acronym style="cursor: hand;" onClick="f_empty_on_exit.click()">{$umLabel.prf_empty_on_exit}</acronym></td>
                      </tr>
                      <tr>
                        <td><img src="images/empty.gif" width="5" height="5"></td>
                      </tr>
  ...
  <tr> 
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                  <td background="themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_sent_title}</b></td>
                <td width="31"><img src="themes/aleborgXP/images/login/right_up_corner.gif" width="31" height="29"></td>
              </tr>
            </table></td>
        </tr>
                ...
                <td><table width="650" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td> 
                          ...
                          <acronym style="cursor: hand;" onClick="f_save_sent.click()">{$umLabel.prf_save_sent} 
                          "<b>{$umLabel.sent_extended}</b>"</acronym></td>
                      </tr>
                      <tr>
                        <td><img src="images/empty.gif" width="5" height="5"></td>
                      </tr>
  ...
  <tr> 
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                  <td background="themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_messages_title}</b></td>
                <td width="31"><img src="themes/aleborgXP/images/login/right_up_corner.gif" width="31" height="29"></td>
              </tr>
            </table></td>
        </tr>
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><table width="650" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                              <td nowrap>&nbsp;{$umLabel.prf_page_limit}&nbsp;</td>
                        <td width="355">{$umRecordsPerPage}</td>
                      </tr>
                      <tr> 
                              <td nowrap>&nbsp;{$umLabel.prf_time_to_refesh}&nbsp;</td>
                        <td>{$umTimeToRefresh}</td>
                      </tr>
                      <tr> 
                              <td colspan="2">
                                <input type="checkbox" name="f_display_images" value="1"{$umDisplayImages} checked>
                                <acronym style="cursor: hand;" onClick="f_display_images.click()">{$umLabel.prf_display_images}</acronym></td>
                      </tr>
                      <tr>
                        <td colspan="2"><img src="images/empty.gif" width="5" height="5"></td>
                      </tr>
  ...
  <tr> 
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                  <td background="themes/aleborgXP/images/login/up_back.gif" class="white"><b>{$umLabel.prf_signature_title}</b></td>
                <td width="31"><img src="themes/aleborgXP/images/login/right_up_corner.gif" width="31" height="29"></td>
              </tr>
            </table></td>
        </tr>
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><table width="650" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                              <td>&nbsp;{$umLabel.prf_signature}</td>
                        <td width="420">{$umSignature}</td>
                      </tr>
                      <tr> 
                        <td colspan="2"><input type="checkbox" name="f_add_sig" value="1"{$umAddSignature}> 
                          <acronym style="cursor: hand;" onClick="f_add_sig.click()">{$umLabel.prf_auto_add_sign}</acronym></td>
                      </tr>
                      <tr>
                        <td colspan="2"><img src="images/empty.gif" width="5" height="5"></td>
                      </tr>
		...
		<td valign=top>
          ...
          <tr> 
                  <td bgcolor=white align="center"><br>
                     <input type="submit" value="{$umLabel.prf_save_button}">
                    <br>
                  </td>
          </tr>
        </table>
