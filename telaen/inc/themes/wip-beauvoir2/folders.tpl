...
<html>
<head>
	<title>UebiMiau Webmail - {$umLabel.folders_to} {$umUserEmail} - Skin by Beauvoir.net</title>
		...
		<td background="inc/themes/beauvoir2/images/ligne-fond.gif">
			<table cellspacing="0" cellpadding="0" width="99.7%" border="0" class="normal" align="center">
				<tr>
					...
					<td align="center" valign="middle" bgcolor="#BFC6D3" height="50" width="83"><img src="inc/themes/beauvoir2/images/folder.gif" border="0"><br>{$umLabel.folders_mnu}</td>
			...
			<tr>
				...
				<td align="center" colspan="5"><br><input type="Text" name="newfolder" class="normal" style="width:180px;border: 1 solid #7F9DB9"> <input type="button" class="button" value="{$umLabel.fld_make_new}" onClick="create()"></td>
				</form>
			</tr>
