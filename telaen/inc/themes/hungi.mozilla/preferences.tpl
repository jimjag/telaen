  ...
  <tr>
    <td valign="top"><form id="prefs_form" name="prefs_form" action="preferences.php" method="post">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr>
            <td height="22" colspan="2" class="headers"><b>{$umLabel.prf_general_title}</b></td>
          </tr>
          <tr>
            <td colspan="2" class="separator"></td>
          </tr>
          <tr>
            <td class="default" width="400">&nbsp;{$umLabel.prf_name}</td>
          ...
          <tr>
            ...
            <td class="default"><select name="editor_mode">
                <option value="text"{if $editorMode eq "text"} selected="selected"{/if}>{$umLabel.prf_default_editor_mode_text}</option>
                <option value="html"{if $editorMode eq "html"} selected="selected"{/if}>{$umLabel.prf_default_editor_mode_html}</option>
              </select></td>
          </tr>
          <tr>
            <td height="22" colspan="2" class="headers"><b>{$umLabel.prf_trash_title}</b></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="22" colspan="2" class="headers"><b>{$umLabel.spam_extended}</b></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="22" colspan="2" class="headers"><b>{$umLabel.prf_sent_title}</b></td>
          </tr>
          <tr>
            <td colspan="2" class="separator"></td>
          </tr>
          ...
          <tr>
            <td  height="22" colspan="2" class="headers"><b>{$umLabel.prf_messages_title}</b></td>
          </tr>
          <tr>
            <td colspan="2" class="separator"></td>
          </tr>
          ...
          <tr>
            <td  height="22" colspan="2" class="headers"><b>{$umLabel.prf_signature_title}</b></td>
          </tr>
          <tr>
            <td colspan="2" class="separator"></td>
          </tr>
          ...
          <tr>
            <td height="40" align="center" style="background-image: url(themes/hungi.mozilla/images/menu-bg.gif)" colspan="2"><table class="buttonTable" cellspacing="0" >
                <tr>
                  ...
                  <td valign="middle" class="buttonMiddle"><input type="submit" name="submit" value="{$umLabel.prf_save_button}" class="button" /></td>
      ...
      <form action="preferences.php" method="post">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" bgcolor="white">
          ...
          <tr>
            <td class="default" width="400"> {$umLabel.filter_field}: </td>
          ...
          <tr>
            <td class="usage" colspan="2"><center>
                <table class="buttonTable" cellspacing="0" align="center">
                  <tr>
                    <td valign="middle" class="buttonLeft">&nbsp;</td>
                    <td valign="middle" class="buttonMiddle"><input type="submit" class="button" value="{$umLabel.filter_add}" /></td>
                    <td valign="middle" class="buttonRight">&nbsp;</td>
                  </tr>
                </table>
              </center></td>
      ...
      <form id="filters_form" name="filters_form" action="preferences.php" method="post">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" bgcolor="white">
          ...
          <tr>
            ...
            <td class="headersLeft">.:<b>{$umLabel.filter_field}</b>:.</td>
            <td class="headersLeft">.:<b>{$umLabel.filter_match}</b>:.</td>
            <td class="headersLeft">.:<b>{$umLabel.filter_type}</b>:.</td>
            <td class="headersLeft">.:<b>{$umLabel.filter_folder}</b>:.</td>
