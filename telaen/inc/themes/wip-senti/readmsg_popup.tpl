					...
					<td bgcolor=white>
						<table width="100%" border=0 cellspacing=1 cellpadding=0>
							...
							<tr bgcolor=white>
								...
								<td class="default">
								{section name=i loop=$umTOList}{if $firstto eq "no"};{/if}&nbsp;{$umTOList[i].name|escape:"html"}{assign var="firstto" value="no"}{sectionelse}&nbsp;{$umLabel.no_recipient_text}{/section}
								</td>
							</tr>	
