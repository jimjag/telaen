...
<td colspan="13">
						<table width="100%" border=0 cellspacing=0 cellpadding=5>
							...
							<tr>
								...
								{/section}&nbsp; <a href="javascript:block_addresses()">{* not fully functional <img src="inc/themes/senti/images/cross.gif" width="15" height="13" border="0" alt="{$umLabel.block_address}"></a>&nbsp; *}<a href="javascript:catch_addresses()"><img src="inc/themes/senti/images/bookmark_it.gif" width="15" height="12" border="0" alt="{$umLabel.catch_address}"></a>
								</td>
							</tr>
							<tr>
