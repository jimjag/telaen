		...
		<td background="inc/themes/beauvoir2/images/ligne-fond.gif">
			<table cellspacing="0" cellpadding="0" width="99.7%" border="0" class="normal" align="center">
				<tr>
					...
					<td align="center" valign="middle" bgcolor="#BFC6D3" height="50" width="83"><img src="inc/themes/beauvoir2/images/search.gif" border="0"><br>{$smLabel.search_mnu}</td>
				...
				<td colspan="5" align="center">
					<table cellspacing="1" cellpadding="0" width="450" border="0" class="normal" bgcolor="#BFC6D3" align="center">
						<tr>
							...
							<td><input type="text" class="normal" name="srcFrom" value="{$smInputFrom|escape:"html"}" size="40" maxlength="40" style="border: 1 solid #7F9DB9;"></td>
						<tr>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$smLabel.sch_subject_hea}:</td>
							<td><input type="text" class="normal" name="srcSubject" value="{$smInputSubject|escape:"html"}" size="40" maxlength="40" style="border: 1 solid #7F9DB9;"></td>
						<tr>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$smLabel.sch_body_hea}:</td>
							<td><input type="text" class="normal" name="srcBody" value="{$smInputBody|escape:"html"}" size="40" maxlength="40" style="border: 1 solid #7F9DB9;"></td>
						<tr>
							<td>&nbsp;</td>
