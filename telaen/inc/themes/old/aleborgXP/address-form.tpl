                    ...
                    <tr> 
                      <td bgcolor=white valign=top> <form name="form1" method="post" action="addressbook.php">
                          ...
                          <table width="400" border="0" cellspacing="1" cellpadding="2">
                            <tr> 
                              <td size="20%"><strong>{$smLabel.adr_name} &nbsp;</strong></td>
                            ...
                            <tr> 
                              ...
                              <td>
                                <input type=text name="state" value="{$smAddrState|escape:"html"}" class="textbox" size="40">
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td>&nbsp;</td>
                              <td><input name="submit" type=submit value="{$smLabel.adr_save}"></td>
                            </tr>
                          </table>
                        </form></td>
                    </tr>
