					...
					<td bgcolor=white>
						<table width="100%" border=0 cellspacing=1 cellpadding=0>
							...
							<tr bgcolor=white>
								...
								<td class="default">
								{section name=i loop=$smTOList}{if $firstto eq "no"};{/if}&nbsp;{$smTOList[i].name|escape:"html"}{assign var="firstto" value="no"}{sectionelse}&nbsp;{$smLabel.no_recipient_text}{/section}
								</td>
							</tr>	
							...
							{if $smHaveCC}
								<tr bgcolor=white>
									...
									<td class="default">
									{section name=i loop=$smCCList}{if $firstcc eq "no"};{/if}&nbsp;{$smCCList[i].name|escape:"html"}{assign var="firstcc" value="no"}{/section}
									</td>
								</tr>	
							{/if}
									...
									<td>
										<table width="100%" border=0 cellspacing=1 cellpadding=0>
											<tr bgcolor="#f1f1f1">
												...
												<tr bgcolor=white>
													<td class="default"> &nbsp;<a href="{$smAttachList[i].normlink}">{$smAttachList[i].name|truncate:30:"...":true|escape:"html"}</a> <a href="{$smAttachList[i].downlink}" target=_blank><img src="./images/download.gif" width="12" height="12" border="0" alt=""></a></td>
