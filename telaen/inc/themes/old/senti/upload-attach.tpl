...
<tr><td class="headers"><b>{$smLabel.up_information_text}</b></td></tr>
<tr><td class="light"><input type=file name=userfile class=textbox size=22 style="width: 250px;"></td></tr>
<tr><td class="light" align=right><input type=submit value="{$smLabel.up_button_text}" name=submit class=button></td></tr>
</form>
</table>
</body>
</html>
