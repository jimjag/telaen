   					...
   					<tr>
   						<td>
   							<div class="yToolbar" id="ParaToolbar">
								   ...
								   <a href="javascript:void(0)" onClick="document.composeForm.switchMode.click()"><font class="normal">{$umLabel.view_source}</font></a> | 
								   <a href="javascript:textmode()"><font class="normal">{$umLabel.text_mode}</font></a> |
								   <a href="javascript:void(0)" onClick="formatC('formatBlock','removeFormat')"><font class="normal">{$umLabel.clear_format}</font></a>
   								</div>
   							</div>
   							<table>
   								<tr>
