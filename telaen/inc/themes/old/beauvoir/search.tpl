	...
	<tr>
		<td valign="middle">
			<table cellspacing="0" cellpadding="0" width="100%" border="0" class="normal" >
				...
				<td align="center" valign="middle" bgcolor="#EAEAEA" height="70" width="83"><img src="inc/themes/beauvoir/search.gif" border="0" width="31" height="31"><br><font class="inactive">{$umLabel.search_mnu}</font></td>
	...
	<tr>
		<td valign="top">
			...
			<tr>
				...
				<td colspan="5" align="center">
					<table cellspacing="1" cellpadding="0" width="450" border="0" class="normal" bgcolor="#EAEAEA" align="center">
						...
						<tr>
							<td>&nbsp;</td>
							<td><input type="submit" value="{$umLabel.sch_button_text}" class="normal"><br></td>
					</table>			
				</td>
				</form>
			</tr>
			...
			<tr>
			    ...
			    <td width="280" bgcolor="#ACB6D1" align="center" valign="middle">.: <b>{$umLabel.sch_subject_hea}</b> :.</td>
			   	<td width="180" bgcolor="#ACB6D1" align="center" valign="middle">.: <b>{$umLabel.sch_from_hea}</b> :.</td>
			    <td width="100" bgcolor="#ACB6D1" align="center" valign="middle">.: <b>{$umLabel.sch_date_hea}</b> :.</td>
			    <td width="150" bgcolor="#ACB6D1" align="center" valign="middle">.: <b>{$umLabel.sch_folder_hea}</b> :.</td>
			</tr>
			...
			<tr bgcolor="#EAEAEA" onmouseover="mOvr(this,'#ACB6D1');" onmouseout="mOut(this,'#EAEAEA');">
				...
				<td valign="middle">&nbsp;{if $umMessageList[i].read eq "false"}<b>{/if}<a href="{$umMessageList[i].readlink}">{$umMessageList[i].subject|truncate:30:"...":true|escape:"html"|default:$umLabel.no_subject_text}</a>{if $umMessageList[i].read eq "false"}</b>{/if}</td>
				<td valign="middle">&nbsp;<a href="{$umMessageList[i].composelink}">{$umMessageList[i].from|truncate:30:"...":true|escape:"html"|default:$umLabel.no_subject_text}</a></td>
				<td align="center" valign="middle">{$umMessageList[i].date|date_format:$umLabel.date_format}</td>
				<td align="center" valign="middle"><a href="{$umMessageList[i].folderlink}">{$umMessageList[i].foldername|escape:"html"}</a></td>
			</tr>
			{sectionelse}
			<tr>
			    <td width="100%" align="center" valign="center" bgcolor="#EAEAEA" colspan="5"><br>{$umLabel.sch_no_results}<br><br></td>
			</tr>
			{/section}
			{/if}
			<tr>
