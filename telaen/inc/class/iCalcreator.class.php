 ...
 * @return void
 */
  public function vcalendar ( $config = array()) {
    $this->_makeVersion();
    $this->calscale   = null;
    $this->method     = null;
    $this->_makeUnique_id();
 ...
 * @return void
 */
  public function vevent( $config = array()) {
 ...
 * @return void
 */
  public function vtodo( $config = array()) {
    $this->calendarComponent();
 ...
 * @return void
 */
  public function vjournal( $config = array()) {
    $this->calendarComponent();
 ...
 * @return void
 */
  public function vfreebusy( $config = array()) {
    $this->calendarComponent();
 ...
 * @return void
 */
  public function valarm( $config = array()) {
    $this->calendarComponent();
 ...
 * @return void
 */
  public function vtimezone( $timezonetype=FALSE, $config = array()) {
