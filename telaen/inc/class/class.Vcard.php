 ...
 *
 * Orig @author Jeroen Desloovere <info@jeroendesloovere.be>
 * Modified: @author Jim Jagielski <jimjag@gmail.com> for Telaen
 */
class VCard
{
    /**
    ...
    public function addAddress(
        ...
        // set property
        $this->setProperty('ADR' . (($type != '') ? ';TYPE=' . $type : ''), $value);
        // TODO: LBL
    }
    ...
    {
        $this->setProperty('EMAIL;TYPE=PREF,INTERNET', $address);
    }
    ...
    {
        $this->setProperty('TEL' . (($type != '') ? ';TYPE=' . $type : ''), $number);
    }
    ...
    {
        $this->setProperty('URL' . (($type != '') ? ';TYPE=' . $type : ''), $url);
    }
