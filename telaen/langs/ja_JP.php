<?php
/ *
 *米国英語（カノニカルリストとフレージング）
 */

$lang = array();
//システムフォルダへ//ユーザーフレンドリーな名前
...
//メールボックスの名前が無効です
$lang['ERROR_INVALID_NAME']= '無効なフォルダ名 - のみを使用して次の文字AZ、AZ、0-9、および - ';
...
//
//日付形式
//％d個=日、％mは=月、％yは=年、％のH=時間は、％M =分
//完全なリストについては、http://www.php.net/strftimeを参照してください
//
...
$lang['prf_save_sentは']= '保存<bは> </ B>内のメッセージを送った';
...
$lang['prf_display_imagesは']= 'ショーは、画像を添付';
...
$lang['blk_informationは']= 'だけが、まだフィルターに含まれていない電子メールを示しています';
$lang['blk_email']= 'メール';
