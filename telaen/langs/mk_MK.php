<? php
/ *
  * САД англиски (канонски листа и изразувањето)
  * /

$ lang = array();

// Кориснички пријателски имиња до систем папки
...
//
// Датум формат
//% D = ден,% m = месец,% Y = година,% H = час,% M = минути
// За комплетна листа, видете http://www.php.net/strftime
//
...
$lang['lng_login_btn'] = 'Влези & GT'; & GT';';
...
$lang['nav_continue'] = '& lt'; & lt'; Продолжи & GT'; & GT';';
$lang['nav_back'] = 'Назад';
...
$lang['sch_button_text'] = 'Барај & GT'; & GT';';
