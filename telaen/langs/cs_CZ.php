<? php
/ *
  * US English (kanonický seznam a frázování)
  * /

$lang = array ();

// Uživatelsky přívětivé jména do systémových složek
...
//
// Formát data
//% D = den,% m = měsíc,% Y = rok,% H = hodina,% M = minuty
// Pro kompletní seznam, vidět http://www.php.net/strftime
//
